...
5- Creat the Project pod mapping a hostpath as a volume for the project to use the generated files in dockerizing the application. You must change hostpath path value below to match your environment and access permissions. thefile is called:
...
14- To check the provisioned PVs use: kubectl get pv
ex:
$ kubectl.exe get pv
NAME                                       CAPACITY   ACCESS MODES   RECLAIM POLICY   STATUS    CLAIM                    STORAGECLASS   REASON    AGE
pvc-13e7d87c-1985-11e8-a6c4-080027c0e4b4   200Mi      RWO            Delete           Bound     default/drkiq-postgres   standard                 2h
pvc-13f0de4d-1985-11e8-a6c4-080027c0e4b4   200Mi      RWO            Delete           Bound     default/drkiq-redis      standard                 2h
